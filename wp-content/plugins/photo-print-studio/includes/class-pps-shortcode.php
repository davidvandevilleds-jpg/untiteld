...
class PPS_Shortcode {
	...
	private function i18n_strings() {
		return array(
			...
			'costForYourFormat' => __( 'voor uw formaat(en)', 'photo-print-studio' ),
			'subtotalLabel'     => __( 'Subtotaal', 'photo-print-studio' ),
			'handlingFeeLabel'  => __( 'Behandelingskost', 'photo-print-studio' ),
			'deliveryHeading'   => __( 'Levering', 'photo-print-studio' ),
			'deliveryShip'      => __( 'Leveren', 'photo-print-studio' ),
			'deliveryPickup'    => __( 'Afhalen', 'photo-print-studio' ),
			'deliveryFeeLabel'  => __( 'Verzendkost', 'photo-print-studio' ),
			...
			'cropBody'          => __( 'Uw foto zelf blijft altijd rechtop staan. Sleep het kader erover om te kiezen wat wordt afgedrukt, gebruik de schuifregelaar om in of uit te zoomen, of draai het kader 90° als het gekozen formaat de andere richting uit staat.', 'photo-print-studio' ),
			'rotate'            => __( 'Kader 90° draaien', 'photo-print-studio' ),
			'formatMismatchTitle' => __( 'Dit formaat past niet op de vorm van uw foto', 'photo-print-studio' ),
			'formatMismatchBody'  => __( 'Het gekozen formaat heeft een andere verhouding dan uw foto, dus een deel van de foto valt buiten het afdrukkader. Gebruik de uitsnede-tool hieronder om te bekijken en aan te passen wat er precies wordt afgedrukt.', 'photo-print-studio' ),
